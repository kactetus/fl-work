...
<?php echo $template['partials']['menu_left']; ?>
	...
	<div id="pr_container">
		<div id="container" class="budget_statistics"></div>
		...
		<div class="set_date_type">
			<br>
				<form>
					...
					<button class="btn btn-default" id="build_budget"><?= lang("to_build"); ?></button>
				<form>
			<br><br>
		</div>
	</div>
...
<script src="<?=base_url();?>media/js/budget_statistic.js"></script>